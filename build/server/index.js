...
const PokedexHeader = ({
  ...
  const [store] = useLocalStoreContext();
  return /* @__PURE__ */ jsx("div", { className: "flex justify-between items-center mb-4", children: !!store?.caughtPokemons?.length && /* @__PURE__ */ jsxs("div", { className: "flex justify-between w-full", children: [
    /* @__PURE__ */ jsxs("h4", { className: "font-bold text-lg flex items-center gap-1", children: [
